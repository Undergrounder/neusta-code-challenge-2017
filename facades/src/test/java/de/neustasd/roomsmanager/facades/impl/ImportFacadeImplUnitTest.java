...
public class ImportFacadeImplUnitTest {
    ...
    public void setUp() throws Exception {
        importFacade = new ImportFacadeImpl(importCsvParser,
                csvImportDataConverter,
                importService,
                importResultDataConverter);
    }

    @Test
    public void testEmptyFile() throws IOException, ImportFacade.ImportException, ImportCsvParser.CsvParsingException, ImportService.ImportException {
        //Prepare
        try(final InputStream fileStream = ImportFacadeImplUnitTest.class.getResourceAsStream("/imports/empty.csv")){
            ...
            final ImportResultData importResultData = ImportResultData.builder()
                    .persons(0)
                    .rooms(0)
                    .build();
            ...
            final ImportResultDto importResultDto = ImportResultDto.builder()
                    .persons(0)
                    .rooms(0)
                    .build();
