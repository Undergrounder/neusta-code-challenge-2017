...
public class ValidImportDataConstraintValidatorUnitTest {
    ...
    private final ValidImportDataConstraintValidator validImportDataConstraintValidator = new ValidImportDataConstraintValidator();
    ...
    public void testEmpty() {
        ...
        final boolean isValid = validImportDataConstraintValidator.isValid(importData, constraintValidatorContext);
